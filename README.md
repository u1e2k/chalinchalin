...
1. **3D物理演算コインプッシャー**:
   ...
   - `AnimatableBody3D` による安定した往復駆動プッシャー
...
2. **ゲームルール**:
   ...
   - レアコイン獲得でボーナス大量加算＆Tilt即時チャージ。
   - 所持コインが0になり、盤面上のコインが静止するとゲームオーバー。

3. **台揺らし（Tilt）システム**:
   - 時間経過でチャージされるエネルギーを消費し、盤面全体に微小な衝撃波とカメラシェイクを加えてコインを前進させます。

4. **プロシージャル・アーケードサウンド**:
   - 外部音声ファイル不要のプロシージャル合成シンセサウンド（チャリン音、ジャラジャラ音、獲得ファンファーレ、ポーズ音など）。
...
| **台揺らし (Tilt)** | `Xボタン` (`btn_x` / 左ボタン) | `X` / `C` | 台を揺らしてコインに衝撃を与える |
